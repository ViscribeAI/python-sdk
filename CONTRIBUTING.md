# Contributing to ViscribeAI

Thank you for your interest in contributing to **ViscribeAI**! We welcome contributions from the community to help improve and grow the project. This document outlines the guidelines and steps for contributing.
...
2. Clone your forked repository:
   ```bash
   git clone https://github.com/ViscribeAI/python-sdk.git
   cd python-sdk
   ```
...
Please adhere to the following guidelines when contributing to ViscribeAI:
...
ViscribeAI is licensed under the **MIT License**. See the [LICENSE](LICENSE) file for more information.
